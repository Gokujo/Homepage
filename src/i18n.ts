  ...
  de: {
    ...
    legal: { 
      ...
      privacy: {
        ...
        contactFormMailto: 'Alternativ können Sie mich direkt per E-Mail an <a href="mailto:info@maxim-harder.de" class="text-blue-600 hover:underline">info@maxim-harder.de</a> kontaktieren.',
        turnstileTitle: 'Cloudflare Turnstile',
        turnstileText: 'Das Kontaktformular ist mit Cloudflare Turnstile geschützt, um Spam und automatisierte Angriffe zu verhindern. Dabei werden keine personenbezogenen Daten an Cloudflare übertragen. Weitere Informationen finden Sie in der <a href="https://developers.cloudflare.com/turnstile/" target="_blank" class="text-blue-600 hover:underline">Cloudflare Datenschutzerklärung</a>.',
  ...
  ru: {
    ...
    legal: { 
      ...
      privacy: {
        ...
        contactFormMailto: 'Альтернативно вы можете связаться со мной напрямую по e-mail: <a href="mailto:info@maxim-harder.de" class="text-blue-600 hover:underline">info@maxim-harder.de</a>.',
        turnstileTitle: 'Cloudflare Turnstile',
        turnstileText: 'Контактная форма защищена Cloudflare Turnstile для предотвращения спама и автоматизированных атак. При этом персональные данные не передаются в Cloudflare. Дополнительную информацию можно найти в <a href="https://developers.cloudflare.com/turnstile/" target="_blank" class="text-blue-600 hover:underline">политике конфиденциальности Cloudflare</a>.',
